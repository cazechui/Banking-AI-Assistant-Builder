      ...
      <div className="p-2 lg:p-3 bg-white border-t border-slate-200">
        <div className="relative flex items-center gap-2">
          <input 
            ...
            placeholder={pendingToolCall ? "Waiting for tool approval..." : config.systemInstruction ? "Type your message..." : "Generate Instructions first to start chatting"}
            className={`flex-1 py-2 px-4 border rounded-full focus:outline-none focus:ring-2 focus:ring-blue-100 focus:bg-white transition text-sm disabled:opacity-80 ${
              !config.systemInstruction 
                ? 'bg-slate-100 border-slate-200 text-slate-500 placeholder-slate-400 cursor-not-allowed' 
